...
URP (universal render pipeline) & built-in compatible.
...
This asset is URP compatible. Simply import the included SGP_5_0_URP unity asset pack and let it overwrite the built-in materials. Change your project settings accordingly.
